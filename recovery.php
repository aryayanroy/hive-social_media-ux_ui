	...
	<main class="bg-body-secondary flex-grow-1">
		<article class="container-xxl">
			<div class="mx-auto my-5 p-3 rounded bg-white" style="max-width: 350px">
                ...
                <p>Before continuing, we need to verify the account.</p>
				<div>
					<label for="#" class="form-label">Username</label>
                    <input type="text" class="form-control" spellcheck="false" required>
				</div>
				<div class="my-3">
					<label for="#" class="form-label">Email address</label>
                    <input type="email" class="form-control" spellcheck="false" required>
				</div>
				<div><button type="submit" class="btn btn-primary w-100">Continue</button></div>
				<div class="mt-3"><a href="#" class="text-decoration-none">Login instead</a></div>
            </div>
		</article>
	</main>
